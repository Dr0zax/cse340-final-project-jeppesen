...
import { showReviewForm, processReview, processDeleteReview } from './forms/review.js';
...
import { requireLogin, requireRole, requireRoles } from "../middleware/auth.js";
...
router.post('/service-requests/update-status', requireLogin, requireRoles('owner', 'employee'), processUpdateServiceRequestStatus);
...
router.get('/admin', requireLogin, requireRoles('owner', 'employee'), showDashboard);
router.get('/admin/users', requireLogin, requireRole('owner'), userManagementPage);
router.get('/admin/contact-responses', requireLogin, requireRoles('owner', 'employee'), contactResponsesPage);
